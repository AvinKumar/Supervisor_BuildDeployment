...
//    public static void main (String[] args) throws SQLException,ExceptionInInitializerError
    public int dropRAPDatabase() throws SQLException,ExceptionInInitializerError {
        ...
        try
        {
            FileReader fr = new FileReader(new File("SQL Scripts/Drop_QASIB2_RAP_SQLDBs.sql"));
            ...
            Connection c = DropRAPDBs.getConnection();

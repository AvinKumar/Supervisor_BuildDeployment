...
//    public static void bkpNPDatabase() throws SQLException,ExceptionInInitializerError
//    public static void main (String[] args) throws SQLException,ExceptionInInitializerError
    public int bkpNPDatabase()throws SQLException,ExceptionInInitializerError
    {
        String s            = new String();
        ...
        try
        {
            FileReader fr = new FileReader(new File("SQL Scripts/Backup_QASIB1_NP_SQLDBs.sql"));
        //    FileReader fr = new FileReader(new File("Delete/DeleteSQL2.sql"));
            ...
            Connection c = BKNPDBs.getConnection();

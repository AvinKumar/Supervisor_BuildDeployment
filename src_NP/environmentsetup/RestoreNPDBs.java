...
//    public static void main (String[] args) throws SQLException,ExceptionInInitializerError
      public int restoreNPDatabase() throws SQLException,ExceptionInInitializerError {
        ...
        try
        {
            FileReader fr = new FileReader(new File("SQL Scripts/Restore_QASIB1_NP_SQLDBs.sql"));
        //    FileReader fr = new FileReader(new File("Delete/DeleteSQL.sql"));
            ...
            Connection c = RestoreNPDBs.getConnection();

...
SET @dbname1 = 'QASIB1'
SET @FileName1 = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Backup\QASIB1.bak' 

-- Details of database QASIB1_ARCH
SET @dbname2 = 'QASIB1_ARCH'
SET @FileName2 = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Backup\QASIB1_ARCH.bak' 

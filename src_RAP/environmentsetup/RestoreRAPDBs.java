...
public class RestoreRAPDBs  {
    ...
    private static final String URL = "jdbc:sqlserver://16.150.57.114:7777";
...
//    public static void main (String[] args) throws SQLException,ExceptionInInitializerError
    public int restoreRAPDatabase() throws SQLException,ExceptionInInitializerError {
        ...
        try
        {
            FileReader fr = new FileReader(new File("SQL Scripts/Restore_QASIB2_RAP_SQLDBs.sql"));
            ...
            Connection c = RestoreRAPDBs.getConnection();

...
//    public static void main (String[] args) throws SQLException,ExceptionInInitializerError
    public int bkpRAPDatabase()throws SQLException,ExceptionInInitializerError {
        ...
        try
        {
            FileReader fr = new FileReader(new File("SQL Scripts/Backup_QASIB2_RAP_SQLDBs.sql"));
            ...
            Connection c = BKRAPDBs.getConnection();

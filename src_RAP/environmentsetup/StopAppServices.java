...
public class StopAppServices {
     
   public static ReadEnvProperties rp = new ReadEnvProperties();
   static Logger log = Logger.getLogger(StopAppServices.class.getName());
...
String command= "cd /avin/avin_shellscripts; pwd; ./Services_Stop.sh;";
